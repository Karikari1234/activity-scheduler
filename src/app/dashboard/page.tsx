...
export default async function DashboardPage() {
  ...
  if (error || !data?.user) {
    ...
    redirect("/schedules/new-scheduler");
  }
  ...
  return (
    <div className="max-w-default mx-auto p-lg">
      <header className="mb-xl flex justify-between items-center">
        <div>
          <h1 className="text-heading font-bold mb-sm text-text-primary">
            Dashboard
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-lg mb-xl">
        <div className="project-card bg-surface p-md rounded-md">
          <h2 className="text-title font-semibold mb-sm text-text-primary">
            Today&apos;s Tasks
          </h2>
          <p className="text-text-secondary">
          ...
          <Link
            href="/schedules/new"
            className="text-primary inline-block hover:underline mt-md"
          >
            Add Schedule
          </Link>
        </div>
        ...
        <div className="project-card bg-surface p-md rounded-md">
          ...
          <p className="text-text-secondary">
            Manage your activities with rich text formatting.
          </p>
          <Link
            href="/schedules"
            className="text-primary inline-block hover:underline mt-md"
